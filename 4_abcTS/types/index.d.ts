...
type EngraverController = import("../src/write/engraver-controller").default;
...
type Selectables = import("../src/write/draw/selectables").default;
...
type AbstractEngraver = import("../src/write/creation/abstract-engraver.ts").default;
...
type Renderer = import("../src/write/renderer").default;
/** @class Renderer */
//interface Renderer {
//	paper?: Svg;
...
type AbsoluteElement = import("../src/write/creation/elements/absolute-element").default;
...
type BeamElem = import("../src/write/creation/elements/beam-element").default;
type BottomText = import("../src/write/creation/elements/bottom-text").default;
type BraceElem = import("../src/write/creation/elements/brace-element").default;
type CrescendoElem = import("../src/write/creation/elements/crescendo-element").default;
type DynamicDecoration = import("../src/write/creation/elements/dynamic-decoration").default;
type EndingElem = import("../src/write/creation/elements/ending-element").default;
type FreeText = import("../src/write/creation/elements/free-text").default;
type GlissandoElem = import("../src/write/creation/elements/glissando-element").default;
//type richText = import("../src/write/creation/elements/rich-text").default;
type Separator = import("../src/write/creation/elements/separator").default;
type StaffGroupElement = import("../src/write/creation/elements/staff-group-element").default;
type Subtitle = import("../src/write/creation/elements/subtitle").default;
type TempoElement = import("../src/write/creation/elements/tempo-element").default;
type TieElem = import("../src/write/creation/elements/tie-element").default;
type TopText = import("../src/write/creation/elements/top-text").default;
type TripletElem = import("../src/write/creation/elements/triplet-element").default;
type VoiceElement = import("../src/write/creation/elements/voice-element").default;
...
type RelativeElement = import("../src/write/creation/elements/relative-element").default;
...
type Svg = import("../src/write/svg").default;

type Classes = import("../src/write/helpers/classes").default;
type GetFontAndAttr = import("../src/write/helpers/get-font-and-attr").default;
type GetTextSize = import("../src/write/helpers/get-text-size").default;
//type SPACE = import("../src/write/helpers/spacing").default;
