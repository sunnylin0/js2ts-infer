...
function renderOne(div: HTMLDivElement, tune: any, params: any, tuneNumber: number, lineOffset: number): void {
    if (params.viewportHorizontal) {
        ...
        div.innerHTML = "";
    var engraver_controller: EngraverController = new EngraverController(div, params);
    ...
    if (params.viewportVertical || params.viewportHorizontal) {
        ...
        var parent: ParentNode = div.parentNode;
...
var renderAbc = function (output: HTMLDivElement, abc: string, parserParams: any, engraverParams: any, renderParams: any): Array<{ [key: string]: any }> {
    ...
    function callback(div: HTMLDivElement, tune: any, tuneNumber: number, abcString: string) {
        var removeDiv: boolean = false;
        if (div === "*") {
            removeDiv = true;
...
function doLineWrapping(div: HTMLDivElement, tune, tuneNumber: number, abcString: string, params) {
    var engraver_controller: EngraverController = new EngraverController(div, params);
