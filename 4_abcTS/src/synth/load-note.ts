...
export default function getNote(url: string, instrument, name, audioContext) {
    ...
    if (!instrumentCache[name]) {
        instrumentCache[name] = new Promise((resolve, reject) => {
            ...
            const noteUrl: string = url + instrument + "-mp3/" + name + ".mp3";
            ...
            xhr.onload = () => {
                ...
                const noteDecoded = (audioBuffer): void => {
