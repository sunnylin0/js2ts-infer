export const legalAccents: Array<string> = [
    'trill',
    'trillh',
    'lowermordent',
    'uppermordent',
...
export const volumeDecorations: Array<string> = [
    'p',
    'pp',
    'f',
    'ff',
...
export const dynamicDecorations: Array<string> = [
    'crescendo(',
    'crescendo)',
    'diminuendo(',
    'diminuendo)',
...
export const accentPseudonyms: Array<Array<string>> = [
    ['<', 'accent'],
    ['>', 'accent'],
    ['tr', 'trill'],
    ['plus', '+'],
...
export const accentDynamicPseudonyms: Array<Array<string>> = [
    ['<(', 'crescendo('],
    ['<)', 'crescendo)'],
    ['>(', 'diminuendo('],
    ['>)', 'diminuendo)']
