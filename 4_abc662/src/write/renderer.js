...
class Renderer {
    ...
    setPadding(abctune) {
        ...
        const setPaddingVariable = (paddingKey, formattingKey, printDefault, screenDefault) => {
    ...
    setVerticalSpace(formatting) {
        // conversion from pts to px 4/3
        const f = (val) => (val !== undefined ? (val * 4) / 3 : undefined);
