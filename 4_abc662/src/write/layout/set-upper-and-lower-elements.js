...
const margin = 1;
const setUpperAndLowerElements = function (renderer, staffGroup) {
    let lastStaffBottom;
...
function setUpperAndLowerVoiceElements(positionY, voice, spacingOption) {
...
function setUpperAndLowerAbsoluteElements(specialYResolved, element, spacingOption) {
