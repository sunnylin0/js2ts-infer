...
class EngraverController {
     ...
     */
    engraveABC(abctunes, tuneNumber, lineOffset) {
        let tunes;
    ...
    engraveTune(abcTune, tuneNumber, lineOffset) {
        var origJazzChords = this.jazzchords;
    ...
    addSelectListener(clickListener) {
