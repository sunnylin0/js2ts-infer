...
export default class ParseHeader {
    ...
    addUserDefinition(line, start, end) {
    ...
    setDefaultLength(line, start, end) {
    ...
    letter_to_inline_header(line, i, startLine) {
