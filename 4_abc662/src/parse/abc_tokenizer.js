...
export default class Tokenizer {
    constructor(lines, multilineVars) {
        this.lineIndex = 0;
        this.lines = lines;
    ...
    getMode(str) {
        const skipAlpha = function (str, start) {
    ...
    tokenize(line, start, end, alphaUntilWhiteSpace) {
    ...
    theReverser(str) {
        ...
        const getTitleNumber = function (s) {
            const regex = /^(\d+)\./;
    ...
    getBrackettedSubstring(line, i, maxErrorChars, _matchChar) {
        const substInChord = function (str) {
            str = str.replace(/\\n/g, "\n");
            str = str.replace(/\\"/g, '"');
            return str;
        };
