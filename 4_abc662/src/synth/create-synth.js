...
export default class CreateSynth {
    constructor() {
        ...
        this.noteEnd = 0;
        this.meterSize = 1;
        this.millisecondsPerMeasure = 1000;
        this.beatsPerMeasure = 4;
        this.meterFraction = { den: 1 };
    }
    init(options) {
        if (!options)
            options = {};
    ...
    _loadBatch(batch, soundFontUrl, startTime, delay) {
        const promises = [];
        batch.forEach(item => {
            if (this.debugCallback)
    ...
    download() { return downloadBuffer(this); }
    ...
    _addSwing(noteMapTracks, swing, meterFraction, pickupLength) {
