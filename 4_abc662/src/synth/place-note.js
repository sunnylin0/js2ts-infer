...
export default function placeNote(outputAudioBuffer, sampleRate, sound, startArray, volumeMultiplier, ofsMs, fadeTimeSec, noteEndSec, debugCallback) {
...
function copyToChannel(toBuffer, fromBuffer, start) {
