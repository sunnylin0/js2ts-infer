declare module 'abcjs' {
	...
	export interface Formatting {
		...
		voicefont: Font;
		wordsfont: Font;
		maxStaves?: number;		//line added
		[key: string]: any;		//line added
	}
	...
	export interface VoiceItemPart {
		...
		endChar: number;
		title: string;
		barNumber?: number; 	//line added
	}

	export interface VoiceItemScale {
		el_type: "scale";
		size: number;
		startChar: number;   //line added
		endChar: number;     //line added
		barNumber?: number;
	}
	...
	export interface TuneObject {
		...
		addElementToEvents: (eventHash: any, element: any, voiceTimeMilliseconds: number, top: number, height: number, line: number, measureNumber: number, timeDivider: number, isTiedState: any, nextIsBar: boolean) => void;
		addUsefulCallbackInfo: (eventList: any[], beatsPerMinute: number) => void;
