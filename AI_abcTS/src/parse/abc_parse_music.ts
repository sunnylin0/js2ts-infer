...
var MusicParser: any = function (this: any, _tokenizer: any, _warn: any, _multilineVars: any, _tune: any, _tuneBuilder: any, _header: any) {
...
var el: any = {};
MusicParser.prototype.parseMusic = function (this: any, line: string) {
	header.resolveTempo();
		...
		if (retInlineHeader[0] > 0) {
			...
			if (ret[0] > 0) {
				...
				if (line[i] === '[') {
					...
					// Single pitch
					var el2: any = {};
					var core: any = getCoreNote(line, i, el2, true);
...
MusicParser.prototype.startNewLine = function (this: any) {
	var params: any = { startChar: -1, endChar: -1 };
