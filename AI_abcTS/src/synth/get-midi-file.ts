...
export default function getMidiFile(source: string | any, options?: any): any {
	const params: any = Object.assign({}, options);
	params.generateInline = false;

	const callback = (div: any, tune: any, index: number) => {
...
function generateMidiDownloadLink(tune: any, midiParams: any, midi: string, index: number): string {
