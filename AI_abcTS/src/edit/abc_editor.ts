...
import EditArea, { ChangeListener } from './abc_editarea';

function gatherAbcParams(params: any): any {
...
export default class Editor implements ChangeListener {
	public abcjsParams: any;
	public indicate_changed: boolean = false;
	public editarea: EditArea;
	public div: HTMLElement | null = null;
	public selectionChangeCallback: ((start: number, end: number) => void) | null = null;
	private clientClickListener: any = null;
	public synth: any = null;
	public generate_midi: any = null;
	public downloadMidi: HTMLElement | null = null;
	public inlineMidi: HTMLElement | null = null;
	public warningsdiv: HTMLElement | null = null;
	public onchangeCallback: ((editor: Editor) => void) | null = null;
	public redrawCallback: ((inProgress: boolean) => void) | null = null;
	public currentAbc: string = "";
	public tunes: any[] = [];
	private bReentry: boolean = false;
	private timerId: any = null;
	private bIsPaused: boolean = false;
	private midiPause: boolean = false;
	private wasDirty: boolean = false;
	private warnings: string[] = [];

	constructor(editarea: string | HTMLTextAreaElement | EditArea, params: any) {
		...
		if (canvasId) {
			...
			if (el.parentNode) el.parentNode.insertBefore(this.div, el);
		}
		...
		if (params.warnings_id) {
			...
			if (this.div && this.div.parentNode) this.div.parentNode.insertBefore(this.warningsdiv, this.div);
		}
	...
	private addClassName(element: HTMLElement, className: string): HTMLElement {
		const hasClassName = (el: HTMLElement, name: string) => {
	...
	private removeClassName(element: HTMLElement, className: string): HTMLElement {
	...
	public paramChanged(engraverParams: any): void {
		if (engraverParams) {
	...
	public synthParamChanged(options: any): void {
	...
	public setDirtyStyle(isDirty: boolean): void {
		if (!this.indicate_changed) return;
	...
	public isDirty(): boolean {
		if (!this.indicate_changed) return false;
		return this.editarea.initialText !== this.editarea.getString();
	}

	public highlight(abcelem: any, tuneNumber: number, classes: any, analysis: any, drag: any, mouseEvent: any): void {
	...
	public pause(shouldPause: boolean): void {
		this.bIsPaused = shouldPause;
		if (!shouldPause) this.fireChanged();
	}

	public millisecondsPerMeasure(): number {
	...
	public pauseMidi(shouldPause: boolean): void {
