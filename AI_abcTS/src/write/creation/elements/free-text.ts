class FreeText {
	...
	constructor(info: any, vskip: number, getFontAndAttr: any, paddingLeft: number, width: number, getTextSize: any) {
		...
		if (text === "") {
			...
			const replaceStandaloneNewlinesForTextBlocks = (input: string) => {
