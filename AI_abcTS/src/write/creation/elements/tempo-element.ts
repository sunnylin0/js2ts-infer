...
class TempoElement {
	public type = "TempoElement";
	public tempo: any;
	public tuneNumber: number;
	public totalHeightInPitches = 6;
	public tempoHeightAbove = 6;
	...
	public createNote(createNoteHead: any, tempo: any, tuneNumber: number): any {
		...
		const ret = createNoteHead(absElem, note, { verticalPos: 0 },
