...
const createNoteHead = function (abselem: AbsoluteElement, c: string | undefined, pitchelem: any, options: any = {}): { notehead: RelativeElement | undefined, accidentalshiftx: number, dotshiftx: number, extraLeft: number } {
