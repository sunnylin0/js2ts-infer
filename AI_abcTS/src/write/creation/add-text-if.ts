function addTextIf(rows: any[], params: any, getTextSize: any): void {
	if (!params.text)
		return;
	...
	const attr: any = { left: params.marginLeft, text: params.text, font: params.font, anchor: params.anchor, startChar: params.info.startChar, endChar: params.info.endChar, 'dominant-baseline': params['dominant-baseline'] };
	...
	let numLines = params.text.split("\n").length;
	...
	if (!params.noMove) {
		const h = (size.height * 1.1) * numLines;
